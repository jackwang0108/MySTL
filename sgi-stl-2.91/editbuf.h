...
struct edit_mark {
	...
	inline unsigned long index_in_buffer(struct edit_buffer *) { return _pos >> 1; }
...
inline buf_char *edit_mark::ptr(struct edit_buffer *buf) { return buf->data + index_in_buffer(buf); }
